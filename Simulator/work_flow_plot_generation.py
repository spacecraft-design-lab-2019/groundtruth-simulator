...
plot1.savefig('quat.png')
plot2.savefig('ang_rates.png')
plot3.savefig('B_field_ECI.png')
plot4.savefig('B_field_body.png')
plot5.savefig('command_hist.png')
plot6.savefig('ang_vel.png')
