...
plot1.savefig('./path/to/artifact/quat.png')
plot2.savefig('./path/to/artifact/ang_rates.png')
plot3.savefig('./path/to/artifact/B_field_ECI.png')
plot4.savefig('./path/to/artifact/B_field_body.png')
plot5.savefig('./path/to/artifact/command_hist.png')
plot6.savefig('./path/to/artifact/ang_vel.png')
